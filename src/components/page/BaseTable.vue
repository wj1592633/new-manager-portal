        ...
        <div class="container">
            <div class="handle-box">
               ...
               <!-- <el-select v-model="query.address" placeholder="地址" class="handle-select mr10">
                ...
                <el-input v-model="query.keyword1" placeholder="部门" class="handle-input mr10"></el-input>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                const url = sysConfig.urlPre + '/v1/employees'
                http.requestGet(url, this.query).then(data => {
                    console.log(data)
                    console.log('data========>')
